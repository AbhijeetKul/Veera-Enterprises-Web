            ...
            <div className="pt-2 border-t">
              ...
              <div className="grid grid-cols-2 gap-2">
                 <Link href="/retail-kolhapur">
                    <a onClick={() => setIsOpen(false)} className="text-center p-2 bg-secondary/20 text-primary text-sm rounded hover:bg-secondary/40">Kolhapur</a>
                 </Link>
                 <Link href="/retail-pune">
                    <a onClick={() => setIsOpen(false)} className="text-center p-2 bg-secondary/20 text-primary text-sm rounded hover:bg-secondary/40">Pune PCMC</a>
                 </Link>
              </div>
            </div>
